									...
									<form  action="{$_SERVER['PHP_SELF']}" method="post">
                                        <div class="row control-group">
                                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                                <label >Name</label>
                                                <input type="text" class="form-control" placeholder="Organization / Individual Name"  name="user_name" id="user_name" required>
...
if (isset($_POST["return_main"])) {
    ...
    if (password_verify($_POST["password2"], $password)) {
        $sqlQuery = "insert into eventUsers values(\"$user_name\", \"$email\", \"$password\")";
...
$page = generatePage($body, "Event Sign Up", "registration.js", "Event Sign Up");
echo $page;
?>